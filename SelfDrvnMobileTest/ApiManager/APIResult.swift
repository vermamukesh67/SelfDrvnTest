...
extension APIResult {
  ...
  ///            same failure.
  public func map<T>(_ transform: (Value) -> T) -> APIResult<T> {
    switch self {
    case .success(let value):
  ...
  /// - returns: A `Result` containing the result of the given closure. If this instance is a failure, returns the
  ///            same failure.
  public func flatMap<T>(_ transform: (Value) throws -> T) -> APIResult<T> {
    switch self {
    case .success(let value):
      do {
  ...
  ///            the same instance.
  public func mapError<T: Error>(_ transform: (Error) -> T) -> APIResult {
    switch self {
    case .failure(let error):
  ...
  /// - Returns: A `Result` instance containing the result of the transform. If this instance is a success, returns
  ///            the same instance.
  public func flatMapError<T: Error>(_ transform: (Error) throws -> T) -> APIResult {
    switch self {
    case .failure(let error):
      do {
  ...
  @discardableResult
  public func withValue(_ closure: (Value) -> Void) -> APIResult {
  ...
  /// - Returns: This `Result` instance, unmodified.
  @discardableResult
  public func withError(_ closure: (Error) -> Void) -> APIResult {
  ...
  /// - Returns: This `Result` instance, unmodified.
  @discardableResult
  public func ifSuccess(_ closure: () -> Void) -> APIResult {
  ...
  /// - Returns: This `Result` instance, unmodified.
  @discardableResult
  public func ifFailure(_ closure: () -> Void) -> APIResult {
